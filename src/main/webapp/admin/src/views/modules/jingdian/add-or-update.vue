    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="景点门票" prop="lvyouluxianMoney">
                       <el-input v-model="ruleForm.lvyouluxianMoney"
                                 placeholder="景点门票" clearable  :readonly="ro.lvyouluxianMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="景点门票" prop="lvyouluxianMoney">
                           <el-input v-model="ruleForm.lvyouluxianMoney"
